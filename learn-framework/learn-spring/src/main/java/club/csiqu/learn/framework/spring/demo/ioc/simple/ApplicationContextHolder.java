package club.csiqu.learn.framework.spring.demo.ioc.simple;

import club.csiqu.learn.framework.spring.demo.ioc.simple.config.SpringConfig;
...
public class ApplicationContextHolder {
    ...
    static {
        ...
        // 通过扫描路径进行初始化上下文
        ANNOTATION_CONTEXT =
                new AnnotationConfigApplicationContext("club.csiqu.learn.framework.spring.demo.ioc.simple.service");
        // 加载 Java配置类的方式初始化上下文
